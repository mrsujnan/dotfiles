Packages To install``
```bash
sudo pacman -S neovim git python reflector bluez blueman bluez-utils p7zip unzip unrar firefox vlc stow tmux zsh fzf zoxide
yay -S  oh-my-posh kanata #install yay first
```
